...
$ocLazyLoad.load([{
	name: 'TestModule',
	files: ['testModule.js', 'resources/components/bootstrap/dist/js/bootstrap.js']
},{
    name: 'AnotherModule',
    files: ['anotherModule.js']
}]);
...
```js
$ocLazyLoad.load([{
	files: ['resources/components/bootstrap/dist/js/bootstrap.js']
}]);
```
...
Single file:
```js
$ocLazyLoad.load('resources/components/bootstrap/dist/js/bootstrap.js');
```

You can also load css and template files:
```js
$ocLazyLoad.load([
	'resources/components/bootstrap/dist/js/bootstrap.js',
	'resources/components/bootstrap/dist/css/bootstrap.css',
...
$ocLazyLoad.load({
	...
	serie: true,
	files: [
		'resources/components/angular-strap/dist/angular-strap.js',
		'resources/components/angular-strap/dist/angular-strap.tpl.js'
	]
});
```
...
$ocLazyLoad.load({
	...
	files: ['resources/components/bootstrap/dist/css/bootstrap.css']
});
```
