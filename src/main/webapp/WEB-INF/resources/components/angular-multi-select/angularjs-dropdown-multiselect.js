        ...
        return {
            ...
            template: function (element, attrs) {
               ...
               // template += '<li ng-hide="!settings.showPreferenceOption" style="padding:5px 5px 5px 5px;"><select class="form-control" ng-model="countyPreference" ng-value="settings.preferenceList" data-ng-change="countyPreferenceList()"><option value="1">Standard</option><option value="2">Custom</option></select></li>';
                template += '<li ng-hide="!settings.showPreferenceOption" style="padding:5px 5px 5px 5px;"><label class="radio-inline"><input type="radio" value="1" name="{{settings.radioButtonName}}" ng-model="countyPreference" data-ng-change="countyPreferenceList()"/><small>{{settings.preferenceAllText}}</small></label><label class="radio-inline"><input type="radio" value="2" name="{{settings.radioButtonName}}" ng-model="countyPreference" data-ng-change="countyPreferenceList()"/><small>{{settings.preferenceSetText}}</small></label></li>';
            ...
            link: function ($scope, $element, $attrs, ctrl) {
                ...
                $scope.settings = {
                    ...
                    disable:false,
                    radioButtonName:'',
                    preferenceAllText:'All',
                    preferenceSetText:'Preferred',
                };
                        ...
                        if ($scope.settings.smartButtonMaxItems > 0) {
                            ...
                            if (totalSelected === 0) {
                            	...
                            	if($scope.countyPreference==1){
                            		return totalSelected+ ' ' + $scope.texts.dynamicButtonTextSuffix+' - '+$scope.settings.preferenceAllText;
                            	}else if($scope.countyPreference==2){
                            		return totalSelected+ ' ' + $scope.texts.dynamicButtonTextSuffix+' - '+$scope.settings.preferenceSetText;
                            	}else{
