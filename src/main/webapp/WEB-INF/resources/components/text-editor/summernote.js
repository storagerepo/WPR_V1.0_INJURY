    ...
    var c = {
        ...
        r = function() {
            ...
            this.showImageDialog = function(c, d) {
                return a.Deferred(function(a) {
                    ...
                    e.one("shown.bs.modal", function(c) {
                        c.stopPropagation(), f.replaceWith(f.clone().on("change", function() {
                        ...
                        a.stopPropagation(), c.focus(), f.off("change"), g.off("keyup"), h.off("click")
                    }).modal("show")
                })
                ...
                return a.Deferred(function(a) {
                    ...
                    f.one("shown.bs.modal", function(c) {
                        c.stopPropagation(), g.val(e.text).keyup(function() {
                            b(h, g.val())
                        }).trigger("keyup").trigger("focus"), h.click(function(b) {
                            b.preventDefault(), f.modal("hide"), a.resolve(g.val())
                        })
                    }).one("hidden.bs.modal", function(a) {
                        a.stopPropagation(), c.focus(), g.off("keyup"), h.off("click")
                    }).modal("show")
                })
                ...
                return a.Deferred(function(a) {
                    ...
                    f.one("shown.bs.modal", function(c) {
                        c.stopPropagation(), g.val(e.text), h.keyup(function() {
                        ...
                        a.stopPropagation(), c.focus(), h.off("keyup")
                    }).modal("show")
                }).promise()
        ...
        s = function() {
            var d = new m,
                ...
                y = function(g) {
                    ...
                    if (h.length > 0) {
                        ...
                        if (d[n] && (v.trigger("focus"), d[n](v, o, m)), -1 !== a.inArray(n, ["backColor", "foreColor"])) e.updateRecentColor(h[0], n, o);
                        ...
                        } else if ("showHelpDialog" === n) k.showHelpDialog(v, t);
            ...
            this.bindKeyMap = function(a, b) {
                ...
                var f = a.toolbar,
                    g = f.find(".note-dimension-picker-mousecatcher");
        ...
        t = function() {
            ...
            b = {
                ...
                fontsize: function(a) {
                    return '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" data-toggle="dropdown" title="' + a.font.size + '" tabindex="-1"><span class="note-current-fontsize">14</span> <b class="caret"></b></button><ul class="dropdown-menu"><li><a data-event="fontSize" data-value="12"><i class="fa fa-check icon-ok"></i> 12</a></li><li><a data-event="fontSize" data-value="13"><i class="fa fa-check icon-ok"></i> 13</a></li><li><a data-event="fontSize" data-value="14"><i class="fa fa-check icon-ok"></i> 14</a></li><li><a data-event="fontSize" data-value="15"><i class="fa fa-check icon-ok"></i> 15</a></li><li><a data-event="fontSize" data-value="16"><i class="fa fa-check icon-ok"></i> 16</a></li><li><li><a data-event="fontSize" data-value="17"><i class="fa fa-check icon-ok"></i> 17</a></li><li><a data-event="fontSize" data-value="18"><i class="fa fa-check icon-ok"></i> 18</a></li><li><a data-event="fontSize" data-value="20"><i class="fa fa-check icon-ok"></i> 20</a></li><li><a data-event="fontSize" data-value="22"><i class="fa fa-check icon-ok"></i> 22</a></li><li><a data-event="fontSize" data-value="24"><i class="fa fa-check icon-ok"></i> 24</a></li><li><a data-event="fontSize" data-value="36"><i class="fa fa-check icon-ok"></i> 36</a></li></ul>'
                },
                color: function(a) {
            ...
            var e = function() {
                ...
                j = function(a) {
                    return '<table class="note-shortcut"><thead><tr><th></th><th>' + a.shortcut.action + "</th></tr></thead><tbody><tr><td>âŒ˜ + Z</td><td>" + a.history.undo + "</td></tr><tr><td>âŒ˜ + â‡§ + Z</td><td>" + a.history.redo + "</td></tr><tr><td>âŒ˜ + ]</td><td>" + a.paragraph.indent + "</td></tr><tr><td>âŒ˜ + [</td><td>" + a.paragraph.outdent + "</td></tr><tr><td>âŒ˜ + ENTER</td><td>" + a.hr.insert + "</td></tr></tbody></table>"
                },
                k = function(a, b) {
