...
public class LawyersController {
	    ...
	    @RequestMapping(value="/mergeLawyers",method=RequestMethod.POST)
	   	public String mergeLawyers(@RequestBody LawyersForm lawyersForm,ModelMap model)
	   	{
	    ...
	    @RequestMapping(value="/saveUpdateLawyers",method=RequestMethod.POST)
	   	public String saveLawyers(@RequestBody LawyersForm lawyersForm,ModelMap model)
	   	{
	    ...
	    @RequestMapping(value="/deleteLawyers",method=RequestMethod.POST)
	   	public String deleteLawyers(@RequestParam("id") Integer id,ModelMap model)
	   	{
	    	
	    	lawyersService.deleteLawyers(id);
	    	model.addAttribute("requestSuccess",true);
	   		return "/returnPage";
	   	}
	    ...
	    @RequestMapping(value="/getLawyersByLawyerAdmin",method=RequestMethod.GET)
	   	public String getLawyersByLawyerAdmin(ModelMap model)
	   	{
	    	...
	    	model.addAttribute("lawyersForms",lawyersService.getLawyersListByLawyerAdmin(lawyerAdminId));
	    	model.addAttribute("requestSuccess",true);
	   		return "/returnPage";
	   	}
