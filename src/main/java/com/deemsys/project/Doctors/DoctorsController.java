...
public class DoctorsController {
	...
	public String mergeDoctors(@RequestBody DoctorsForm doctorsForm,
			ModelMap model) {
	...
	public String saveDoctors(@RequestBody DoctorsForm doctorsForm,
			ModelMap model) {
	...
	public String deleteDoctorsByClinicId(
	...
	public String getNameByClinicId(@RequestParam("clinicId") Integer clinicId,
			Model model) {
		model.addAttribute("doctorsForm",
				doctorsService.getNameByClinicId(clinicId));
	...
	public String getDoctorsByClinic(
			@RequestParam("clinicId") Integer clinicId, ModelMap model) {
		model.addAttribute("doctorsForms",
				doctorsService.getDoctorsByClinic(clinicId));
		model.addAttribute("requestSuccess", true);
		return "/returnPage";
	}
}
